...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, default='E:\PatchFormer\dtu\pt085\\patchmatchnet012_l3.ply')
    parser.add_argument('--scan', type=int, default=12)
    parser.add_argument('--mode', type=str, default='pcd', choices=['mesh', 'pcd'])
    parser.add_argument('--dataset_dir', type=str, default='D:/DTUeval-python-master/EvaCode/')
    parser.add_argument('--vis_out_dir', type=str, default='E:\PatchFormer\dtu\pt085')
